...
custom_local_manifest = ".repo/local_manifests/nuclear_manifest.xml"
custom_default_revision = "mm6.0"
custom_dependencies = "nuclear.dependencies"
org_manifest = "NuclearSlim"  # leave empty if org is provided in manifest
org_display = "NuclearSlim"  # needed for displaying
